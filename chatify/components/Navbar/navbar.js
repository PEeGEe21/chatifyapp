...
export const Navbar = ({handleShowMobileMenu, currentUserImage, currentUserName, currentUser}) => {
    const router = useRouter();
    const [showMenu, setShowMenu] = useState(false);
    const [dropdownMobileMenu, setDropdownMobileMenu] = useState(false);
    ...
    <nav className="bg-white shadow dark:bg-gray-800 border-b header">
        <div className="container px-6 py-3 mx-auto">
            <div className="md:flex md:items-center md:justify-between">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex md:hidden">
                        <button type="button" className="relative z-10 flex items-center p-2 mr-2 text-sm text-gray-600 bg-white border border-transparent rounded-md dark:text-white dark:bg-gray-800 focus:outline-none "  aria-label="toggle profile dropdown" data-dropdown-toggle="menu-dropdown" onClick={handleShowDropdownMobileMenu}>
                        ...
                        <button type="button" className="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu" onClick={(e)=>handleShowMobileMenu(e)}>
                ...
                {dropdownMobileMenu &&
                    <div id="menu-dropdown7" className=" absolute right-10 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800 block md:hidden">
                        <Link href="/">
                ...
                <div className="flex-1 md:flex md:items-center md:justify-between">
                    ...
                    <div className="flex items-center mt-4 md:mt-0 hidden md:inline-flex">
                        <button className="hidden mx-4 text-gray-600 transition-colors duration-200 transform md:block dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none " aria-label="show notifications" onClick={handleShowNotifications}>
            ...
            <button type="button" className="relative z-10 flex items-center p-2 text-sm text-gray-600 bg-white border border-transparent rounded-md focus:border-blue-500 focus:ring-opacity-40 dark:focus:ring-opa    city-40 focus:ring-blue-300 dark:focus:ring-blue-400 focus:ring dark:text-white dark:bg-gray-800 focus:outline-none "  aria-label="toggle profile dropdown" data-dropdown-toggle="menu-dropdown" onClick={handleShow}>
                ...
                <span className="mx-1">{currentUserName ? currentUserName : 
                    <Link href="/login">
                    <a className="px-2 py-1 mx-2 mt-2 text-sm font-medium text-gray-700 transition-colors duration-200 transform rounded-md md:mt-0 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700">Log In</a>
            ...
            {showMenu &&
            <div id="menu-dropdown" className=" absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800">
                <Link href="/setAvatar">
                    <a className="flex items-center px-3 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 8C7 5.23858 9.23858 3 12 3C14.7614 3 17 5.23858 17 8C17 10.7614 14.7614 13 12 13C9.23858 13 7 10.7614 7 8ZM12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z" fill="currentColor"></path>
            ...
            {showNotifications && 
                        ...
                        <div className="py-2">
                            <a href="#" className="flex items-center px-4 py-3 -mx-2 transition-colors duration-200 transform border-b border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700">
