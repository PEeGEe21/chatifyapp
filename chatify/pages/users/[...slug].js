...
// console.log(UsersData);
  ...
  const post = UsersData[router.query.id];
  console.log(post);

  // const UserId = slug.value[0];
  // console.log(UserId)

    // let ids = UsersData.map(({ id }) => id);
  //   // console.log(ids, "idsss");
    const user_id = (router.asPath.split("/")[2]);
  //   // console.log(id)
    const singleUser = UsersData.find((item) => item.id == user_id);
  console.log(singleUser, "fkrokcrc")


  useEffect(()=>{
    const handler = (e) => {
      if (showFriendMenu && ref.current && !ref.current.contains(e.target)){
  ...
  // const singleUser = UsersData.find((item) => item.id = id);
  // console.log(singleUser, "hereeee");

  // const handleDelete = (id) =>{
  //     setData(UsersData.filter((item) => item.id === id));
  // }
    // );
    // console.log(product)
  ...
  // console.log(parts);
    ...
    //             console.log(singleUserData.name, "singleUserData");
  ...
  return (
    <>
    <Layout>
    <div className="max-w-[967px] w-full py-4 bg-fuchsia-100 fixed shadow px-2 z-10">
                ...
                <div className="flex items-center justify-between">
                 <div className="relative inline-block ">
                    ...
                    <div  className="relative z-10 flex items-center px-2 py-1 text-sm text-gray-600 bg-white border border-transparent rounded-md focus:border-blue-500 focus:ring-opacity-40 dark:focus:ring-opacity-40 focus:ring-blue-300 dark:focus:ring-blue-400 focus:ring dark:text-white dark:bg-gray-800 focus:outline-none " >
                        ...
                        {/* <span className="mx-1">{router.query.id}</span> */}
                    </div>
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.inner_box}>
          ...
          <div className={"text-bubble", styles.sender_card}>
            <div className="avatar">
              {/* <img src={`data:image/svg+xml;base64,${currentUserImage}`} className="object-cover w-full h-full" alt="" /> */}
            ...
            <p>
              Instantly deploy your Next.js site cos i said so
            </p>
          </div> 
         
          <div className={"text-bubble", styles.receiver_card}>
            <div className="grid_receiver_avatar">
                <img src={(singleUser.avatar) ? `${singleUser.avatar}` :  `/users/default.jpg`} className="object-cover w-full h-full" alt="avatar"/>
        ...
        {/* <div className={styles.grid_receiver}>
