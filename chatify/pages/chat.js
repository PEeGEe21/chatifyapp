...
//     {ssr: false}
//   ];
const Chat = ({currentUser, currentUserName, currentUserImage, currentChat }) => {
...
//   };
  ...
  return (
    <>
    <div className="max-w-[967px] w-full py-4 bg-fuchsia-100 fixed shadow px-2 z-10 hidden md:block ">
